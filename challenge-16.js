...
var fullName = 'patricia-aparecida-custodio-nunes-joao-rambo'
...
for ( var i = 0; i < nome.length; i++){
    ...
    var nomeUp = nome[i].charAt(0).toUpperCase() + nome[i].slice(1);
    nomeUp2 = nomeUp2 + " " +nomeUp;
...
*/
console.log( '\nMeus amigos:' );
var nomes = [ 'patricia', ' renan', 'matheus', 'renato', 'vilma']
