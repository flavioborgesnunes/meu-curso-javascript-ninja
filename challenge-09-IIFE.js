...
console.log( sum(function( numUm, numDois){
...
*/
var subtraction = calculator(50, 70);
var multiplication = calculator(3, 25);
var division = calculator(144, 12);
var mod = calculator(52, 23);
/*
