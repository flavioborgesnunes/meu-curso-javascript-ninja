...
/*
  ...
  */
   var person1 = {name :'Flávio', lastname : 'Nunes' };
   var person2 = {name :'Renan', lastname : 'Fratucci'};
...
function sum(){
  ...
  */
                    //  var userEntry = doc.getElementById('entrada');
                    //  var $button = doc.querySelector('#button');
                    //  var $mostrar = doc.querySelector('.mostrar')
                    //  $button.addEventListener('click',
                    //     function (){
                    //       console.log(userEntry.value);
                    //       $mostrar.value = userEntry.value;

                    //     }, false)TINHA FICADO BAO...
  /*
