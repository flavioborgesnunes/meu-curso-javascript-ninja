...
console.log(text.replace(/Manuel Marques de Sousa/, 'Flávio Borges Nunes'));
...
console.log( text.replace(/brasileiro/, 'passense MG'));
...
*/
console.log( '\nReplace de datas:' );
function replaceDate( regex, day, mes , year){
    return day + '/' + getMonthNumber(mes) + '/' + year;
}
