...
// // metodo indexOff
// var arr = ['F', 'l', 'a', 'v', 'i', 'o'];
// console.log( arr.indexOf('v', 2)); // retorna o index do parametro a partir do segundo parametro, se não houver retorna '-1'.

// // lastIndexOff
// var arr = ['F', 'l', 'a', 'v', 'i', 'o'];
// var index = arr.lastIndexOf('l')
// console.log( index);
 (function(){
...
// ? não funciona, cada array é único, a menos que seja stribuido
